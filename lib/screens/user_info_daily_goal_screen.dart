...
// class _UserInfoDailyGoalScreenState extends State<UserInfoDailyGoalScreen> {
//   late double convertedWaterGoal; // stored in mL
//   late double initialSliderValue; // stored in L
//   late List<double> tickValues;
//   double widgetMaxGoal = 0;

//   @override
//   void initState() {
//     super.initState();
//     convertedWaterGoal = widget.waterGoal; // mL
//     _setupDynamicSlider();
//   }
...
//   @override
//   Widget build(BuildContext context) {
//     final displayWaterGoal = (convertedWaterGoal / 1000).toStringAsFixed(1);
...
//               ),
//             ),
//             SizedBox(height: AppDimensions.dim117.h),

//             /// ✅ Display always in Liters (L)
//             RichText(
//               text: TextSpan(
//                 children: [
//                   TextSpan(
//                     text: displayWaterGoal,
//                     style: TextStyle(
//                       fontFamily: 'MuseoModerno-Bold',
//                       fontSize: 36.sp,
//                       color: const Color(0xFFB3F0F8),
//                       shadows: [
//                         Shadow(
...
//             SizedBox(height: AppDimensions.dim114.h),
...
//                   setState(() {
//                     HapticFeedback.selectionClick();
//                     convertedWaterGoal = val * 1000; // store as mL
//                     log("Slider value: $val L => ${convertedWaterGoal.toInt()} mL");
//                   });
//                 },
//               ),
//             ),
...
//             Navigator.pushAndRemoveUntil(
//               context,
//               MaterialPageRoute(builder: (context) => BottomNavScreenNew()),
//               (route) => false,
//             );
//           },
//         ),
